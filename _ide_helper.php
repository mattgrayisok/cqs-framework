 ...
 * Generated for Laravel 5.1.8 (LTS) on 2015-08-23.
 *
...
namespace {
    ...
    class Acting extends \App\Facades\ActingFacade{
        ...
        public static function asUser($user){
            return \App\Facades\ActingModel::asUser($user);
        }
         ...
         * @static 
         */
        public static function asMyself(){
            return \App\Facades\ActingModel::asMyself();
        }
         ...
         * @static 
         */
        public static function asWho(){
            return \App\Facades\ActingModel::asWho();
        }
